    ...
    public class MeshNavigatorTest
    {
        ...
        private List<HalfEdge> LocateAndAssertMidEdgeVertices(Face startFace, Face targetFace)
        {
            ...
            foreach (var edge in targetFace.GetEdges())
            {
                ...
                var vertex = new Vertex(midPoint.X, midPoint.Y);

                var locator = MeshNavigator.LocatePointInMesh(startFace, vertex);
        ...
        private void LocateAndAssertInside(Face startFace, Face targetFace)
        {
            ...
            var locator = MeshNavigator.LocatePointInMesh(startFace, insidePoint);
